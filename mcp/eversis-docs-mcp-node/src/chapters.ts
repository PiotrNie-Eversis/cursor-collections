/**
 * Section model aligned with mcp/eversis-docs-mcp/chapters.py (python-docx).
 * Operates on w:p OOXML elements in word/document.xml (body-level paragraphs only).
 */
...
/** Insert `newEl` immediately after `after` (same parent). */
