---
name: eversis-implementing-backend
...
- `eversis-sql-and-database-understanding` — for database schema design, query optimization, and ORM integration
- `eversis-technical-context-discovering` — for understanding project conventions before implementing
- `eversis-implementation-gap-analysing` — for verifying current state before making changes
- `eversis-codebase-analysing` — for understanding existing architecture and patterns
- `eversis-implementing-ci-cd` — for CI/CD pipeline setup and deployment strategies
