...
Next.js App Router-specific patterns for the `eversis-implementing-filters` skill. Load this reference when the project uses Next.js App Router (preferred for new Eversis consumer work).
