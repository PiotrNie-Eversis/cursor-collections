...
- `eversis-creating-agents` - to understand how skills relate to agent definitions and avoid overlap
- `eversis-creating-prompts` - to understand how prompts reference and trigger skills
- `eversis-technical-context-discovering` - to discover existing skill patterns in the project before creating a new one
- `eversis-codebase-analysing` - to analyze existing skills and identify conventions to follow
- `eversis-creating-instructions` - to understand when project rules belong in instruction files rather than skill content
