...
- `eversis-technical-context-discovering` - for understanding project conventions and standards to review against
- `eversis-sql-and-database-understanding` - for validating SQL quality, index coverage, query performance, schema design, and ORM usage patterns
- `eversis-engineering-prompts` - for reviewing LLM prompt code: prompt structure, injection defenses, delimiter separation, output format, and anti-patterns