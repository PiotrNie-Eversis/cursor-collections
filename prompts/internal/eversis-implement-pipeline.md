...
- Infrastructure provisioning → `@prompts/internal/eversis-implement-terraform.md`
- Kubernetes deployment configuration → `@prompts/internal/eversis-deploy-kubernetes.md`
- Monitoring and alerting → `@prompts/internal/eversis-implement-observability.md`

<!-- Eversis port; upstream: tsh-implement-pipeline -->
