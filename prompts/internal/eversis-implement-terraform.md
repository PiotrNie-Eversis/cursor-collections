...
- CI/CD pipelines for Terraform → `@prompts/internal/eversis-implement-pipeline.md`
- Kubernetes workload configuration → `@prompts/internal/eversis-deploy-kubernetes.md`
- Monitoring infrastructure → `@prompts/internal/eversis-implement-observability.md`

<!-- Eversis port; upstream: tsh-implement-terraform -->
