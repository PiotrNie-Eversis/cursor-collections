...
description: "Create custom instructions (.instructions.md or copilot-instructions.md) for Cursor / Copilot Collections upstream. Analyzes existing project conventions, determines the appropriate instruction type and scope, creates the instructions file, and validates against best practices."
...
<!-- Eversis port; upstream: tsh-create-custom-instructions -->
