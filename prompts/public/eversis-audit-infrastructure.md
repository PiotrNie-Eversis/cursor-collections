...
### Remediation Roadmap
1. [Critical] Description → `@prompts/internal/eversis-implement-terraform.md`
2. [High] Description → `@prompts/internal/eversis-deploy-kubernetes.md`
3. [Medium] Description → `@prompts/internal/eversis-implement-observability.md`
```
...
- Implementing fixes → `@prompts/internal/eversis-implement-terraform.md`, `@prompts/internal/eversis-deploy-kubernetes.md`, `@prompts/internal/eversis-implement-pipeline.md`, `@prompts/internal/eversis-implement-observability.md`
- Application code security → coordinate with software engineer

<!-- Eversis port; upstream: tsh-audit-infrastructure -->
