...
- `tsh-codebase-analysing` - for the structured codebase analysis process only (note: this prompt's "Report Structure" section overrides any report/template instructions from the skill)
...
- The skills to load (`tsh-codebase-analysing`, `tsh-code-reviewing` from `.github/skills/`)
...
<!-- Eversis port; upstream: tsh-review-codebase -->
