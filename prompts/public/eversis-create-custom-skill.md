...
description: "Create a new custom skill (SKILL.md) for Cursor / Copilot Collections upstream. Analyzes existing skills for patterns, guides through design decisions, creates the skill file with supporting resources, and validates against best practices."
...
<!-- Eversis port; upstream: tsh-create-custom-skill -->
