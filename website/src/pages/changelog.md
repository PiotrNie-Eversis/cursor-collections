...
- **Business Docs normative spec** — [`website/docs/specs/business-docs-workflow.md`](https://github.com/PiotrNie-Eversis/cursor-collections/blob/main/website/docs/specs/business-docs-workflow.md) (BA Word workflow requirements; migrated from local `docs/specs/` in 2026-06-19).
