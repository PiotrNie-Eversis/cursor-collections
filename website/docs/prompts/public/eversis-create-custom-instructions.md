...
4. **Create** — Edit or add files using **`tsh-creating-instructions`**.
...
1. Open `.github/skills/tsh-creating-instructions/SKILL.md` and follow its decision framework (what belongs in rules vs long-form AGENTS).
