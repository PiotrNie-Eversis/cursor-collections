...
1. **Customization researcher** — Analyzes existing `.cursor/rules`, `.cursor/prompts/`, skills, and related docs; reads references; extracts patterns. **Read-only** (summaries, not bulk paste of sources).
