...
Procedural skills live under **`.github/skills/tsh-*/`** as **`SKILL.md`** (and optional `references/` / `assets/`). **Do not** register that path under Cursor **Agent Skills** for this framework.
