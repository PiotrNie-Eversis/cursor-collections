...
- `eversis-creating-agents` — role rules vs long prose
- `eversis-creating-skills` — instruction vs skill boundary
- `eversis-creating-prompts` — prompts reference rules, not duplicate them
